...
app.post('/send-welcome', async (req: Request, res: Response) => {
  try {
    const { registeredEmail, name, portalId, password, parentCode, studentEmail } = req.body as {
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
        ...
        <div style="padding:30px;background:#ffffff;">
          ...
          <div style="background:#fff3cd;padding:15px;border-radius:8px;margin:20px 0;border:1px solid #ffc107;">
            ...
            <p style="margin:0;color:#856404;">Can't find this email? Check your <strong>Spam</strong> or <strong>Junk</strong> folder and mark it as "Not Spam" so you receive future emails from us.</p>
          </div>
...
app.post('/create-account', async (req: Request, res: Response) => {
  try {
    ...
    const data = await response.json() as { status?: number; errors?: string[] | null };
