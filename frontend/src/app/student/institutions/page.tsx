  ...
  if (error) {
    return (
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Institution Matching</h1>
          <p className="text-gray-600 mt-1">Find institutions that match your profile</p>
        </div>
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {filteredMatches.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-xl border border-gray-100">
          ...
          <p className="text-gray-500 text-lg">No matching institutions found</p>
